...
#include "./inc/SelectionOperations.h"
#include "./inc/ReplacementOperations.h"
...
TSP::TSP()
{
	...
	//GaFitnessProgressCriteriaParams critParam(1, true, GFC_LESS_THEN, GSV_BEST_FITNESS, 10000);
	//GaFitnessProgressCriteriaParams critParam( 1, true, GFC_LESS_THEN, GSV_BEST_FITNESS, 50000 );
	//GaFitnessProgressCriteriaParams critParam(1, true, GFC_LESS_THEN, GSV_BEST_FITNESS, 100000);
	GaFitnessProgressCriteriaParams critParam(1, true, GFC_LESS_THEN, GSV_BEST_FITNESS, TspCities::nGenerationLimit);
